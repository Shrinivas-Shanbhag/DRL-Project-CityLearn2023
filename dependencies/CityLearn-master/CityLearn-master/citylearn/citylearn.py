    ...
    **kwargs : dict
    ...
    def evaluate(self, control_condition: EvaluationCondition = None, baseline_condition: EvaluationCondition = None, comfort_band: float = None) -> pd.DataFrame:
        ...
        district_level = pd.DataFrame([{
            ...
            'value': safe_division(CostFunction.ramping(get_net_electricity_consumption(self, control_condition))[-1],
            ...
            'value': safe_division(CostFunction.one_minus_load_factor(get_net_electricity_consumption(self, control_condition), window=24)[-1],
            ...
            'value': safe_division(CostFunction.one_minus_load_factor(get_net_electricity_consumption(self, control_condition), window=730)[-1],
            ...
            'value': safe_division(CostFunction.peak(get_net_electricity_consumption(self, control_condition), window=24)[-1],
                CostFunction.peak(get_net_electricity_consumption(self, baseline_condition), window=24)[-1]),
        }, {
            'cost_function': 'annual_peak_average',
            'value': safe_division(CostFunction.peak(get_net_electricity_consumption(self, control_condition), window=8760)[-1],
